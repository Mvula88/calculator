          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Clear customs via Dar es Salaam, complete registration, drive your car',
                icon: FileCheck
              }
            ].map((step, index) => (
            ...
            {[
              {
                ...
                a: 'Most customers save K80,000 to K200,000 compared to local dealer prices. The exact amount depends on the vehicle model and specifications.'
              },
              {
              ...
              },
              {
                ...
                a: 'Typically 8-10 weeks from purchase to delivery via Dar es Salaam, plus 2-3 weeks for customs clearance and registration.'
              },
              {
