            ...
            <div className="bg-gradient-to-r from-amber-600 to-orange-600 rounded-lg p-4 sm:p-6 shadow-2xl border-2 border-amber-400">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="text-white">
                  ...
                  <a href="/zm/guide#pricing" className="inline-flex items-center gap-2 bg-white text-orange-600 px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-xs sm:text-sm md:text-base">
