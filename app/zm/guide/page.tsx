...
export default function ZambiaGuidePage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50">
      ...
      <FloatingSignupButton country="zm" />
      <CountrySelector />
      <GuideHeader 
        country="zm" 
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-16 z-20">
          ...
          <p className="text-xl md:text-2xl text-white text-center mb-8 max-w-3xl mx-auto leading-relaxed drop-shadow-lg">
            The same import process dealers charge <span className="font-bold text-red-400">K800,000</span> for,
            you can do yourself for <span className="font-bold text-emerald-400">K150,000</span> in agent fees.
            <br />
