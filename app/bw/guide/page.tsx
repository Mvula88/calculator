  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50">
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-sky-50 to-cyan-50 opacity-50"></div>
        <div className="relative max-w-6xl mx-auto px-6 py-16">
          ...
          <p className="text-xl md:text-2xl text-gray-700 text-center mb-8 max-w-3xl mx-auto leading-relaxed">
            The same import process dealers charge <span className="font-bold text-red-600">P80,000</span> for,
            you can do yourself for <span className="font-bold text-blue-600">P15,000</span> in agent fees.
            <br />
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="bg-gradient-to-br from-blue-50 to-sky-50 rounded-2xl p-12 border-2 border-blue-200">
            ...
            <p className="text-xl text-gray-700 mb-6">
              If our guide doesn't save you at least P10,000 on your first import,
              we'll refund every thebe. No questions asked.
            </p>
