          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Clear customs via Durban/Walvis Bay, complete registration, drive your car',
                icon: FileCheck
              }
            ].map((step, index) => (
            ...
            {[
              {
                ...
                a: 'Most customers save P40,000 to P120,000 compared to local dealer prices. The exact amount depends on the vehicle model and specifications.'
              },
              {
              ...
              },
              {
                ...
                a: 'Typically 7-9 weeks from purchase to delivery via transit ports, plus 2-3 weeks for customs clearance and registration.'
              },
              {
