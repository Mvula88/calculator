      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-2xl font-bold text-green-600 mb-8">
            Save P30,000 to P100,000. Every Single Time.
          </p>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">BURS duty calculator included - know your exact total</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="h-6 w-6 text-green-600 flex-shrink-0 mt-0.5" />
                <div>
                  ...
                  <p className="text-gray-600">Direct to Walvis Bay, avoid Durban risks</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="h-6 w-6 text-green-600 flex-shrink-0 mt-0.5" />
                <div>
                  ...
                  <p className="text-gray-600">Trans-Kalahari route, every step explained</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="h-6 w-6 text-green-600 flex-shrink-0 mt-0.5" />
                <div>
                  <strong className="text-lg">Register your car in Botswana</strong>
                  <p className="text-gray-600">Complete process from BURS to plates</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 p-6 bg-gradient-to-r from-green-50 to-blue-50 rounded-lg text-center">
              ...
              <p className="text-xl font-bold text-blue-600 mt-2">Your Turn to Save P100,000 →</p>
            </div>
          </div>
        </div>
