      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Learn how to import cars from Japan to Botswana via Durban/Walvis Bay. No experience needed - our step-by-step Botswana car import guide shows you everything.</p>
          </div>
                ...
                <div className="p-8">
                  ...
                  <div className="mb-6">
                    <div className="flex items-baseline">
                      <span className="text-5xl font-black text-blue-600">P404</span>
                    </div>
                    <p className="text-sm text-blue-600 font-semibold mt-2">Essential import guidance</p>
                  </div>
                  
                  <div className="space-y-4 mb-8">
                    {[
                      "Complete 55-page import guide",
                      "Durban to Gaborone procedures guide",
            ...
            <div className="relative">
              ...
              <Card className="h-full border-2 border-blue-400 shadow-xl bg-gradient-to-br from-blue-50 to-sky-50">
                <div className="p-8">
                  ...
                  <div className="mb-6">
                    <div className="flex items-baseline">
                      <span className="text-5xl font-black bg-gradient-to-r from-blue-600 to-sky-600 bg-clip-text text-transparent">P1,618</span>
                    </div>
                    <p className="text-sm text-blue-600 font-semibold mt-2">Complete import toolkit</p>
                  </div>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 to-sky-600 text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-black mb-6">
            Start Importing Cars from Japan to Botswana Today
          </h2>
          <p className="text-2xl mb-8 text-blue-100">
            Start your import journey today and join our growing community of successful importers via Durban/Walvis Bay.
          </p>
          ...
          <Link href="/register?country=bw&package=mastery">
            ...
            >
              Start Your Botswana Import Journey - Learn From Our Members →
            </Button>
          </Link>
