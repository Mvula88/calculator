          ...
          <div className="mt-10 grid lg:grid-cols-12 gap-10">
            <div className="lg:col-span-5">
              ...
              <ValidatedCheckoutButton
                ...
                country="na"
                size="lg"
                className="group mt-8 h-14 px-8 bg-amber-400 text-zinc-900 hover:bg-amber-300 font-semibold rounded-full shadow-[0_0_0_1px_rgba(0,0,0,0.08),0_16px_40px_-12px_rgba(251,191,36,0.55)] transition-colors text-base"
              >
                Get instant access
                <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-0.5" />
              </ValidatedCheckoutButton>
            ...
            <div className="lg:col-span-7">
              ...
              <ul className="divide-y divide-white/[0.06]">
                {memberFeatures.slice(0, 5).map((item, i) => (
