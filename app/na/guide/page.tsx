        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-16 z-20 w-full">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white mb-6 sm:mb-8 leading-relaxed bg-black/30 backdrop-blur-sm rounded-lg p-4 max-w-3xl mx-auto">
              <strong>What we do:</strong> We guide you through every step of importing a quality used car from Japan to Namibia. From finding the right car to driving it home.
            </p>
          </div>
