          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Clear customs at Durban, complete registration, drive your car',
                icon: FileCheck
              }
            ].map((step, index) => (
            ...
            {[
              {
                ...
                a: 'Most customers save R50,000 to R150,000 compared to local dealer prices. The exact amount depends on the vehicle model and specifications.'
              },
              {
              ...
              },
              {
                ...
                a: 'Typically 6-8 weeks from purchase to delivery at Durban, plus 1-2 weeks for customs clearance and registration.'
              },
              {
