            ...
            <div className="bg-gradient-to-r from-amber-600 to-orange-600 rounded-lg p-4 sm:p-6 shadow-2xl border-2 border-amber-400">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="text-white">
                  ...
                  <a href="/za/guide#pricing" className="inline-flex items-center gap-2 bg-white text-orange-600 px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-xs sm:text-sm md:text-base">
        ...
        <div className="container mx-auto px-3 sm:px-4 max-w-7xl">
          ...
          <div className="max-w-xl mx-auto">
            ...
            <Card className="relative overflow-hidden hover:shadow-2xl transition-all duration-300 border-2 hover:border-green-500">
              <div className="absolute top-0 right-0 bg-gradient-to-r from-green-600 to-emerald-600 text-white text-[10px] sm:text-xs font-bold px-2 py-1 sm:px-4 sm:py-2 rounded-bl-lg">
                EVERYTHING INCLUDED
              </div>
              ...
              <CardHeader className="pb-4 sm:pb-6 pt-8 sm:pt-6">
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                  <Crown className="h-8 w-8 sm:h-10 sm:w-10 lg:h-12 lg:w-12 text-green-500" />
                  <span className="text-xs sm:text-sm font-semibold bg-green-100 text-green-700 px-2 py-1 sm:px-3 sm:py-1 rounded-full">
                    Complete Solution
                  </span>
                </div>
              ...
              <CardContent className="space-y-3 sm:space-y-4 px-4 sm:px-6">
                <ul className="space-y-2 sm:space-y-3">
                  <li className="flex items-start gap-2 sm:gap-3">
                    <Star className="h-4 w-4 sm:h-5 sm:w-5 text-green-500 mt-0.5 flex-shrink-0" />
