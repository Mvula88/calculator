  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden min-h-screen flex items-center">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-green-900 to-yellow-900"></div>
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-1/2 -left-1/2 w-full h-full bg-gradient-to-br from-green-500/10 to-transparent rounded-full animate-pulse"></div>
          <div className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-gradient-to-tl from-yellow-500/10 to-transparent rounded-full animate-pulse delay-1000"></div>
        </div>
        
        <div className="relative max-w-7xl mx-auto px-6 py-20 z-20">
          {/* Premium Trust Badge */}
          <div className="flex justify-center mb-8">
            <div className="inline-flex items-center gap-3 bg-gradient-to-r from-green-500 via-yellow-600 to-emerald-600 text-white px-8 py-4 rounded-2xl shadow-2xl border border-white/20 backdrop-blur-sm">
              <Crown className="h-6 w-6" />
              <span className="font-bold text-base tracking-wide">SOUTH AFRICA'S PREMIER IMPORT EDUCATION PLATFORM</span>
              <Crown className="h-6 w-6" />
            </div>
          </div>
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-2xl md:text-3xl text-green-100 mb-6 font-light leading-relaxed max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-12">
              ...
              <Card className="bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all duration-300 h-full">
                <CardContent className="p-6">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="font-bold text-xl text-white">Save R30K-100K</h3>
                      <p className="text-green-300 font-medium">Per vehicle import</p>
                    </div>
                  </div>
            ...
            <div className="group">
              <Card className="bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all duration-300 h-full">
                <CardContent className="p-6">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="bg-yellow-500 p-3 rounded-xl shadow-lg group-hover:scale-110 transition-transform">
                      <Clock className="h-7 w-7 text-white" />
                    </div>
                    <div>
                      <h3 className="font-bold text-xl text-white">45-60 Days</h3>
                      <p className="text-yellow-300 font-medium">Complete process</p>
                    </div>
                  </div>
                  <p className="text-gray-300 text-sm">From purchase to registration in South Africa</p>
                </CardContent>
              </Card>
            </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-emerald-300 font-medium">Success stories daily</p>
                    </div>
                  </div>
                  <p className="text-gray-300 text-sm">Join successful importers across South Africa</p>
                </CardContent>
              </Card>
            </div>
          </div>
          ...
          <div className="text-center mb-12" id="signup">
            <div className="bg-white/5 backdrop-blur-md rounded-3xl p-8 border border-white/10 max-w-4xl mx-auto">
              <div className="flex flex-col lg:flex-row gap-4 justify-center items-center">
                <Link href="/register?country=za&package=mistake" className="group">
                  <Button 
                    size="lg" 
                    variant="outline" 
                ...
                <Link href="/register?country=za&package=mastery" className="group">
                  <Button 
                    size="lg" 
                    className="font-bold text-lg px-10 py-6 h-auto bg-gradient-to-r from-green-600 via-yellow-600 to-emerald-600 hover:from-green-700 hover:via-yellow-700 hover:to-emerald-700 shadow-2xl group-hover:scale-105 transition-all duration-300 group-hover:shadow-green-500/25"
                  >
              ...
              <CardContent className="p-8">
                <div className="grid md:grid-cols-3 gap-8 items-center">
                  ...
                  <div className="text-center md:text-right">
                    ...
                    <p className="text-gray-300">Successful imports across South Africa</p>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-20">
            ...
            <h2 id="learn-section" className="text-5xl md:text-6xl font-black mb-6">
              <span className="bg-gradient-to-r from-slate-800 via-green-600 to-yellow-600 bg-clip-text text-transparent">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="group">
                <Card className="h-full border-2 border-gray-100 hover:border-green-300 hover:shadow-2xl transition-all duration-300 bg-white group-hover:bg-gradient-to-br group-hover:from-white group-hover:to-green-50">
                  <CardContent className="p-8 relative">
                    {/* Step Number */}
                    <div className="absolute top-4 right-4 text-6xl font-black text-gray-100 group-hover:text-green-100 transition-colors">
                      {item.step}
                    </div>
                    ...
                    {/* Content */}
                    <h3 className="font-bold text-xl mb-4 text-gray-900 group-hover:text-green-900 transition-colors">
                      {item.title}
                    </h3>
                    ...
                    {/* Learn More Link */}
                    <div className="flex items-center gap-2 mt-6 text-green-600 font-semibold opacity-0 group-hover:opacity-100 transition-opacity">
          ...
          <div className="text-center mt-16">
            <Card className="bg-gradient-to-r from-green-600 to-yellow-600 border-0 max-w-4xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link href="/register?country=za&package=mistake">
                    <Button 
                      variant="outline" 
                      size="lg" 
                      className="font-bold text-lg px-8 bg-white/10 border-white/30 text-white hover:bg-white hover:text-green-600"
                    >
                  ...
                  <Link href="/register?country=za&package=mastery">
                    <Button 
                      size="lg" 
                      className="font-bold text-lg px-8 bg-white text-green-600 hover:bg-gray-100 shadow-lg"
                    >
      ...
      <section className="py-24 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {/* Essential Guide */}
            <div className="group">
              <Card className="h-full border-2 border-gray-200 hover:border-green-400 hover:shadow-2xl transition-all duration-300 bg-white overflow-hidden">
                <CardHeader className="bg-gradient-to-r from-green-50 to-emerald-50 border-b border-green-100">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-4xl font-black text-green-600 mb-1">R499</div>
                ...
                <CardContent className="p-8">
                  <div className="space-y-4 mb-8">
                    {[
                      ...
                      <div key={i} className="flex items-start gap-3 group">
                        <div className="bg-emerald-100 p-1 rounded-full mt-0.5 group-hover:bg-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    <Link href="/register?country=za&package=mistake">
                      <Button 
                        variant="outline"
                        className="w-full h-14 text-lg font-bold border-2 border-green-300 text-green-600 hover:bg-green-600 hover:text-white hover:shadow-lg transition-all duration-300 group-hover:scale-[1.02]"
                        size="lg"
                      >
            ...
            <div className="group relative">
              ...
              <div className="absolute -top-6 left-1/2 -translate-x-1/2 z-20">
                <div className="bg-gradient-to-r from-green-600 via-yellow-600 to-emerald-500 text-white px-6 py-3 rounded-2xl shadow-2xl flex items-center gap-2 border-2 border-white">
              ...
              <Card className="h-full border-2 border-green-300 hover:border-green-500 shadow-2xl bg-gradient-to-br from-white via-green-50/30 to-yellow-50/30 overflow-hidden group-hover:shadow-green-500/20 transition-all duration-300">
                <CardHeader className="bg-gradient-to-r from-green-50 via-yellow-50 to-emerald-50 border-b border-green-200">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="text-right">
                      <div className="text-4xl font-black bg-gradient-to-r from-green-600 via-yellow-600 to-emerald-500 bg-clip-text text-transparent mb-1">
                        R1,999
                      </div>
                ...
                <CardContent className="p-8">
                  <div className="bg-gradient-to-r from-green-100 to-yellow-100 rounded-2xl p-4 mb-6 border border-green-200">
                    <div className="flex items-center gap-2">
                      <Sparkles className="h-5 w-5 text-green-600" />
                      <p className="text-green-800 font-bold">Everything in Essential Guide PLUS:</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 mb-8">
                    {[
                      ...
                      <div key={i} className="flex items-start gap-3 group">
                        <div className="bg-gradient-to-br from-yellow-400 to-green-500 p-1 rounded-full mt-0.5 shadow-sm group-hover:shadow-md transition-all">
                  ...
                  <div className="space-y-4">
                    <Link href="/register?country=za&package=mastery">
                      <Button 
                        className="w-full h-14 text-lg font-bold bg-gradient-to-r from-green-600 via-yellow-600 to-emerald-500 hover:from-green-700 hover:via-yellow-700 hover:to-emerald-600 shadow-2xl hover:shadow-green-500/30 transition-all duration-300 group-hover:scale-[1.02]"
                        size="lg"
                      >
          ...
          {/* Professional Trust Indicators */}
          <div className="mt-16">
            <Card className="bg-gradient-to-r from-gray-50 to-green-50 border-2 border-green-100 max-w-5xl mx-auto">
              <CardContent className="p-8">
                <div className="grid md:grid-cols-4 gap-6 items-center">
                  ...
                  <div className="text-center">
                    <div className="bg-amber-100 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-3">
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="space-y-4" itemScope itemType="https://schema.org/FAQPage">
            {faqs.map((faq, index) => (
              <Card 
                key={index} 
                className="border-2 border-gray-100 hover:border-green-300 transition-all duration-300 overflow-hidden"
                itemScope 
                itemProp="mainEntity" 
              ...
              >
                ...
                {expandedFaq === index && (
                  <div 
                    className="border-t border-gray-100 bg-gradient-to-r from-green-50 to-yellow-50"
                    itemScope 
          ...
          <div className="mt-16 text-center">
            <Card className="bg-gradient-to-r from-green-600 to-yellow-600 border-0 max-w-4xl mx-auto">
              <CardContent className="p-12">
                <MessageCircle className="h-12 w-12 text-green-200 mx-auto mb-6" />
                <h3 className="text-3xl font-bold text-white mb-4">
      ...
      {/* Professional Trust & Assurance Section */}
      <section className="py-24 bg-gradient-to-b from-gray-50 to-white">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <Card className="border-2 border-emerald-100 hover:border-emerald-300 hover:shadow-xl transition-all duration-300 group">
              <CardContent className="p-8 text-center">
                <div className="bg-emerald-100 w-20 h-20 rounded-3xl flex items-center justify-center mx-auto mb-6 group-hover:bg-emerald-200 transition-colors">
            ...
            <Card className="border-2 border-green-100 hover:border-green-300 hover:shadow-xl transition-all duration-300 group">
              <CardContent className="p-8 text-center">
                <div className="bg-green-100 w-20 h-20 rounded-3xl flex items-center justify-center mx-auto mb-6 group-hover:bg-green-200 transition-colors">
                  <Shield className="h-10 w-10 text-green-600" />
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">100% Secure & Legal</h3>
                <p className="text-gray-600 leading-relaxed">
            ...
            <Card className="border-2 border-yellow-100 hover:border-yellow-300 hover:shadow-xl transition-all duration-300 group">
              <CardContent className="p-8 text-center">
                <div className="bg-yellow-100 w-20 h-20 rounded-3xl flex items-center justify-center mx-auto mb-6 group-hover:bg-yellow-200 transition-colors">
            ...
            <Card className="bg-gradient-to-r from-green-500 via-yellow-600 to-emerald-600 border-0 overflow-hidden">
              <CardContent className="p-12 text-center text-white relative">
                ...
                <div className="relative z-10">
                  <BadgeCheck className="h-16 w-16 mx-auto mb-6 text-green-200" />
      ...
      <section className="py-24 bg-gradient-to-br from-slate-900 via-green-900 to-yellow-900 text-white relative overflow-hidden">
        {/* Background Effects */}
        ...
        <div className="relative max-w-6xl mx-auto px-6 text-center z-10">
          {/* Premium Badge */}
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-green-500 to-yellow-500 px-6 py-3 rounded-2xl font-bold text-white mb-8 shadow-2xl border border-white/20">
          ...
          <p className="text-2xl md:text-3xl mb-12 text-green-100 max-w-4xl mx-auto font-light leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-12">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              ...
              <p className="text-green-200">Every step mapped out from start to finish</p>
            </div>
            
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              <Users className="h-12 w-12 text-yellow-400 mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-2">Proven Community</h3>
              <p className="text-green-200">Learn from hundreds of successful importers</p>
            </div>
            
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              <DollarSign className="h-12 w-12 text-emerald-400 mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-2">Guaranteed Savings</h3>
              <p className="text-green-200">Save R30K-100K on every import</p>
            </div>
          </div>
              ...
              <CardContent className="p-12">
                ...
                <div className="flex flex-col lg:flex-row gap-6 justify-center items-center mb-8">
                  ...
                  <Link href="/register?country=za&package=mastery" className="group">
                    <Button 
                      size="lg"
                      className="h-16 px-12 text-xl font-bold bg-gradient-to-r from-green-500 via-yellow-600 to-emerald-600 hover:from-green-600 hover:via-yellow-700 hover:to-emerald-700 shadow-2xl group-hover:scale-105 transition-all duration-300 group-hover:shadow-green-500/30"
                    >
