...
export default function SouthAfricaThankYouContent() {
    ...
    <main className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      <div className="max-w-2xl mx-auto px-6 py-16">
        <Card className="p-8 text-center">
          ...
          <Button asChild size="lg" className="w-full bg-green-600 hover:bg-green-700" disabled={isSettingAccess}>
            <Link href="/portal">
              {isSettingAccess ? (
                <>
