    ...
    <>
      ...
      <section className="relative isolate overflow-hidden bg-zinc-950 text-white flex flex-col">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          ...
          {/* Two-column composition: price block (left) + numbered manifest (right) */}
          <div className="mt-12 grid lg:grid-cols-12 gap-12 lg:gap-16">
            ...
            {/* Manifest column — credits-block style */}
            <div className="lg:col-span-7">
              ...
              <ul className="divide-y divide-white/[0.06]">
                {[
                  ...
                  <li key={item} className="group flex items-center justify-between gap-4 py-4">
