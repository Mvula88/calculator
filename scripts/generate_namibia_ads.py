...
<style>
  *{{margin:0;padding:0;box-sizing:border-box}}
  ...
  .content{{position:absolute;left:90px;bottom:130px;right:120px;z-index:7;max-width:820px}}
  .cat{{font-family:'Inter',sans-serif;font-size:12px;font-weight:700;letter-spacing:4px;text-transform:uppercase;color:var(--gold);margin-bottom:30px}}
  ...
  h1{{font-family:'Playfair Display',serif;font-weight:700;font-size:88px;line-height:0.94;letter-spacing:-2.4px;color:#fff;margin-bottom:0;text-shadow:0 2px 24px rgba(0,0,0,0.55)}}
  h1 .it{{font-style:italic;font-weight:700;color:var(--gold)}}
  .arrow-row{{margin-top:24px;display:flex;align-items:flex-start;gap:18px;max-width:760px}}
  .arrow-row .arrow{{color:var(--gold);font-size:36px;line-height:1;flex-shrink:0;margin-top:-4px}}
  .arrow-row .sub{{font-family:'Playfair Display',serif;font-style:italic;font-weight:400;font-size:34px;line-height:1.25;color:#fff;letter-spacing:-0.4px;text-shadow:0 1px 14px rgba(0,0,0,0.7)}}
  .arrow-row .sub b{{font-weight:700;color:var(--gold);font-style:normal}}

  .rule{{width:48px;height:1px;background:var(--gold);margin:36px 0 24px;opacity:0.95}}
  .lede{{font-family:'Inter',sans-serif;font-weight:400;font-size:20px;line-height:1.55;color:rgba(255,255,255,0.92);max-width:720px;text-shadow:0 1px 14px rgba(0,0,0,0.7)}}
