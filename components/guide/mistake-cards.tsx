...
const mistakes: Mistake[] = [
  ...
  },
  {
    ...
    problem: 'Consignee has unpaid debts with shipping line, gets blacklisted. Container transferred to state warehouse. Massive storage fees accumulate daily. Risk of cargo auction if not claimed within 3 months.',
    fix: 'CRITICAL: Always verify your consignee or clearing agent with the shipping line BEFORE shipping. Check if they have outstanding debts with shipping lines (Maersk, MSC, etc). Have backup contacts. Never let cargo sit for months without action. Understand who is responsible for which fees BEFORE shipping. If in doubt, list yourself or a verified clearing firm as consignee. Use companies such as Transworld cargo etc.',
    realStory: '⚠️ REAL CASE UPDATE (April-November 2025): One of our team members experienced a serious issue involving a 2019 Golf 7.5 TSI High Line Meister that was part of a container shipped under a consignee later found to be blacklisted by Maersk for unpaid debts. After contacting Maersk, they confirmed that the consignee had been banned and that the container was handed over to the State. Maersk was no longer involved and advised contacting Terminal Investment Namibia (TiN) — the company managing port operations. TiN confirmed that the storage cost for the container's release had reached N$152,694.70, with the following daily charges: First 5 days: N$380 + 15% VAT/day, Next 5 days: N$619 + 15% VAT/day, Thereafter: N$662 + 15% VAT/day. Because storage fees were billed collectively under the banned consignee, it was impossible to pay for one vehicle independently. Attempts to negotiate a payment arrangement were unsuccessful. Ultimately, the container was handed over to the State, where importers are given three months to claim ownership. Once that period lapses, the container and all vehicles are auctioned. LESSON LEARNED: Always verify your consignee or clearing agent with the shipping line before shipping. A single unreliable consignee can lead to total loss, even if your vehicle is fully paid for.',
  ...
  },
  {
    ...
    realStory: 'Took me 14 days to find the only certified translator in Namibia. Called embassy, courts, everyone. Now use Ritsuko Abrahams +264 81 124 1991.',
    stage: 'Documentation Preparation',
    severity: 'major',
