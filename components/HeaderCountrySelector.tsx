...
const countries = [
  { code: 'na', name: 'Namibia', flag: '🇳🇦', currency: 'N$1,499' },
  { code: 'za', name: 'South Africa', flag: '🇿🇦', currency: 'R1,499' },
  { code: 'bw', name: 'Botswana', flag: '🇧🇼', currency: 'P1,151' },
  { code: 'zm', name: 'Zambia', flag: '🇿🇲', currency: 'ZK2,043' },
]
